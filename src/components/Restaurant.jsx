...
const Restaurant = (props) => {
  ...
  const [mobile, setMobile] = useState("9875321146");
                    ...
                    <div className="row p-2" key={index} >
                      ...
                      <div className="col-4 d-flex justify-content-end">
                        <div className="menu-food-item">
                          ...
                          {item.qty > 0 ? <div className="order-item-count section ">
                            <span className="hand" onClick={() => removeQty(index)}>  - </span>
                            <span>{item.qty}</span>
                            <span className="hand" onClick={() => addQty(index)}>   +</span>
                          </div> : <button className="btn btn-primary btn-sm add" onClick={() => addQty(index)}>
                            Add
                          </button>
                          }
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button
                className="btn btn-danger"
                data-bs-target="#modalMenuItem" emt
                data-bs-toggle="modal"
              >
                Back
              </button>
